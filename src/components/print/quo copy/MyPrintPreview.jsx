      ...
      <>
        <div className="print-head" >
          <div className="print-title flex">
            <div className="flex grow-0" style={{ width: 360}}>
              <Flex className="mb-0">
                <Typography.Title
                  level={4}
                  align="end"
            ...
            <div className="flex grow-0 items-center" style={{ width: 190}}>
              <img src={logo} alt="" style={{ width: 150 ,verticalAlign: 'top',marginTop :'-12px'}} />
            </div>
            <div
          ...
          <div className="flex ps-3 grow-0" style={{ width: "100%" }}>
            <Flex className="mb-1.5" vertical>
              ...
              <Typography.Text className="tx-info" >
                TEL.098-1929391 ID LINE: 0981929391 E-mail:prevailinternational89@gmail.com
              </Typography.Text>
              <Typography.Text className="tx-info" >

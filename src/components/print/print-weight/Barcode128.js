/* ============================================================
   Barcode Code128-B แบบ SVG — ไม่พึ่ง library ภายนอก
   (ยกมาจากฟอร์ม NSF gr-tags)
============================================================ */
...
function encode(text) {
  ...
  for (const v of values) {
    ...
    for (let i = 0; i < p.length; i++) {
      bars.push({ width: Number(p[i]), fill: i % 2 === 0 });
    }
  }
  return { bars, text: clean };
}

...
const API_URL = { 
  ...
  API_GETFRESH: `/reports/fresh/search.php`,
  ...
  API_GETOUTSTANDINGBYCUSTOMER: `/reports/outstanding-by-customer/search.php`,
};
...
const ReportService = () => { 
  ...
  const getFresh = (parm = {}, config = {}) => api.post(`${API_URL.API_GETFRESH}`, parm, config);
  ...
  const getOutstandingByCustomer = (parm = {}, config = {}) => api.post(`${API_URL.API_GETOUTSTANDINGBYCUSTOMER}`, parm, config);

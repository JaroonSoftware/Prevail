...
const FreshReport = () => {
  const PAGE_COOKIE_KEY = "fresh-report";
  ...
  const getData = useCallback((data) => {
    rpservice
      .getFresh(data, { ignoreLoading: getIgnoreLoading() })
      .then((res) => {
        const { data } = res.data;
      ...
      <Col span={12} style={{ paddingInline: 0 }}>
        <Flex gap={4} justify="end">
          ...
          <Button
            ...
            onClick={() => {
              const url = `${window.location.origin}/fresh-report-print`;
